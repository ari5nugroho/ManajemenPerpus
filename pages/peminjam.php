...
$judul = "Peminjam";
$judul_singkat = "Peminjam";
$tambah_link = "tambah_peminjam.php";

$cari = $_GET['cari'] ?? '';
$data = mysqli_query($conn, "
    SELECT * FROM tb_peminjam 
    WHERE nama_peminjam LIKE '%$cari%' OR no_hp LIKE '%$cari%' OR alamat LIKE '%$cari%'
                    ...
                    <tbody>
                        ...
                        while ($d = mysqli_fetch_array($data)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_peminjam.php?id=<?= $d['id_peminjam']; ?>" class="btn btn-sm btn-warning me-1">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <a href="../proses/peminjam_proses.php?hapus&id=<?= $d['id_peminjam']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus?')">
